...
import { Card, CardContent, Typography, CircularProgress, useTheme, Box, Stack, Alert, useMediaQuery } from "@mui/material";
...
const VoteResults: React.FC = () => {
    ...
    //             <Title label="Results" />
    //             <Typography textAlign="center">No votes have been cast yet.</Typography>
    //         </Stack>
    //     );
    // }
